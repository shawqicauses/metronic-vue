        ...
        <div class="card-body p-0">
          <div class="card-px text-center py-20 my-10">
            ...
            <p class="text-gray-400 fs-5 fw-semibold mb-13">
              <span>
                ...
                <br />
                Kickstart your CRM by adding a your first language
              </span>
            </p>
            <button
              type="button"
          ...
          <div class="text-center px-5">
            <img
              ...
              alt="Add Languages Illustration"
      ...
      <div class="card">
        ...
        <div class="card-body py-4">
          <data-table
            ...
            <template #main="{row: language}">
              <span class="form-check form-check-custom form-check-solid">
                <input
                  class="form-check-input"
                  type="radio"
                  :checked="language.main == 1 ? 'checked' : 'false'"
                  name="main"
                  @click="setMainLang(language.id)"
                  value="1" />
              </span>
            </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const setMainLang = function setMainLang(id) {
      axiosClient.get(`/languages/main/${id}`).then(() => {
        store.dispatch("getAPILanguages")
      })
    }
