...
import TableContent from "@/components/admin/kt-datatable/table-partials/table-content/TableContent.vue";
import TableFooter from "@/components/admin/kt-datatable/table-partials/TableFooter.vue";
